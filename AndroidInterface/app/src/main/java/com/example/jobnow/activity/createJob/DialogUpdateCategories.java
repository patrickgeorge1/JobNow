...
public class DialogUpdateCategories extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        recyclerViewSelected.setAdapter(new RecycleViewAdapterCategory(getActivity(), selectedCategories, unselectedCategories, R.layout.listview_selected_category, R.id.textView_selectedCategory, R.id.button_selectedCategory));
        ...
        recyclerViewUnselected.setAdapter(new RecycleViewAdapterCategory(getActivity(), unselectedCategories, selectedCategories, R.layout.listview_unselected_category, R.id.textView_unselectedCategory, R.id.button_unselectedCategory));
